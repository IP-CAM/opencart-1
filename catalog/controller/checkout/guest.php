...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		*/
        ...
        $data['country_id'] = 146;  //TODO::declare the global country id //country_id is autoset, whatever in above step
        $this->load->model('localisation/zone');
        $data['zones'] = $this->model_localisation_zone->getZonesByCountryId(146); //TODO::declare the global country id
	...
	public function save() {
		...
		if (!$json) {
			...
			*/
            ...
            $this->request->post['country_id'] = 146; //TODO::declare the global country id
